...
public class vistaInscrito2 extends javax.swing.JFrame {

    public vistaInscrito2() {
        initComponents();
        pack();
    ...
    private void initComponents() {
        ...
        titulo.setText("Introducción a la Programación");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaInscrito2().setVisible(true);
            }
        });
    }
