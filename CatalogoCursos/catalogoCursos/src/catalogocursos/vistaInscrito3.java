...
public class vistaInscrito3 extends javax.swing.JFrame {

    public vistaInscrito3() {
        initComponents();
        pack();
    ...
    private void initComponents() {
        ...
        titulo.setText("Sistemas de Información II");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaInscrito3().setVisible(true);
            }
        });
    }
