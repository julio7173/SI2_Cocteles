...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2023 a las 05:58:29
...
-- Base de datos: `nose`
--
CREATE DATABASE IF NOT EXISTS `nose` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `nose`;
...
('root', '[{\"db\":\"biblioteca\",\"table\":\"libros\"}]');
...
('root', 'biblioteca', 'libros', '{\"CREATE_TIME\":\"2023-10-19 18:35:28\"}', '2023-10-19 22:39:11');
...
('root', '2023-10-19 22:48:50', '{\"Console\\/Mode\":\"show\",\"lang\":\"es\",\"Console\\/Height\":-27.99799999999999}');
